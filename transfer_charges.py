...
from polysaccharide.polymers.filters import is_charged, has_monomers_chgd
...
if __name__ == '__main__':
    ...
    assign_large_structures = mgr_large.logging_wrapper(
        loggers=loggers,
        proc_name='Large structure rectification'
    )(Polymer.populate_pdb)

    assign_large_structures(structure_dir)