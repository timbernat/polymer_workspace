...
python -m polymer_master   -src "$coll_dir/$full_name" redux     -pdb "$pdb_dir/$redux_name/${redux_name}_structures" -mono "$pdb_dir/$redux_name/${redux_name}_monomers" -N $max_chain_len -f peg_modified paam_modified pnipam_modified
